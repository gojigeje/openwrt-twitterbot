...
pilih_respon() {
  respon_array=(
      ...
      "ga usah pake marah ya {target}.. just kidding"
      ...
      "Hehe.. {target} ternyata gokil juga ya, bisa ga mandi sampe 3 hari.. super gokil"
      "iih,, si {target} sejak kemaren mention aku terus.. kalo ngefans langsung bilang aja kali"
      "ini udah hari ke 3 si {target} ga mandi kayaknya ya?"
      ...
      "nggak bosen elu stalking aku sejak kemaren {target} ?"
      "Oi oi {target},, sabar dulu boss.. kalo ngefans jangan maksa!"
      "pede amat lo {target}.. aku laporin @gojigeje lo.."
      ...
      "{target} <-- kayaknya doi ngefans sama aku"
      ...
      "{target} ga usah rempong gitu napa.. aku bisa ge er ntar.."
      "{target} ini fans sejati aku guys.. foto aku ditempel2 gitu di kamarnya"
      "{target} ini siapa yaa? sok kenal sok dekat bingit.."
      "{target} mention berarti ngefans,, ngefans berarti berani follow aku"
      ...
      "{target} plis jangan alay gitu.. mules liatnya.."
      "{target} sedari dulu kamu kan memang gitu.."
      "{target} temannya @gojigeje ya? apa fansnya dia??"
    )
